...
import com.example.bookstore.message.UsersMessage;
...
public class UserMsgEncoder implements Encoder.Text<UsersMessage> {
    @Override
    ...
    public String encode(UsersMessage usersMessage) throws EncodeException {
        ...
        try (JsonGenerator jsonGenerator = Json.createGenerator(stringWriter)) {
            jsonGenerator.writeStartObject().write("type", "users").writeStartArray("userlist");
